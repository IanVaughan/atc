//------------------------------------------------------------------------------
// IDD_CONTROLS_MAIN.java:
//		Implementation for container control initialization class IDD_CONTROLS_MAIN
//
...
public class IDD_CONTROLS_MAIN
{
	...
	// Constructor
	//--------------------------------------------------------------------------
	public IDD_CONTROLS_MAIN (Container parent)
	{
		m_Parent = parent;
	}
	...
	public boolean CreateControls()
	{
		...
		//----------------------------------------------------------------------
		m_Layout = new DialogLayout(m_Parent, 90, 90);
		...
		m_Parent.add(Turn);
		m_Layout.setShape(Turn, 7, 6, 72, 34);

		IDC_BUTTON2 = new Button ("Flight Level");
		m_Parent.add(IDC_BUTTON2);
		m_Layout.setShape(IDC_BUTTON2, 7, 48, 72, 34);
