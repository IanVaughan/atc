//------------------------------------------------------------------------------
// IDD_CONTROLS_FH.java:
//		Implementation for container control initialization class IDD_CONTROLS_FH
//
...
public class IDD_CONTROLS_FH
{
	...
	// Constructor
	//--------------------------------------------------------------------------
	public IDD_CONTROLS_FH (Container parent)
	{
		m_Parent = parent;
	}
	...
	public boolean CreateControls()
	{
		...
		//----------------------------------------------------------------------
		m_Layout = new DialogLayout(m_Parent, 61, 149);
		...
		m_Layout.setShape(IDC_RIGHT, 23, 100, 31, 8);

		IDC_LEFT = new Checkbox ("Left", group1, false);
		m_Parent.add(IDC_LEFT);
		m_Layout.setShape(IDC_LEFT, 7, 90, 21, 10);
		...
		m_Layout.setShape(IDC_SEND_FH, 7, 119, 47, 23);
